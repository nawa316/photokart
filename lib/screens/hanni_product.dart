...
import '../screens/update_stock_page.dart';
...
class HanniProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // tambahkan ini supaya nav bar muncul lagi
      bottomNavigationBar: BottomNavBar(
        currentIndex: 0, // tab bag aktif
        onTap: (index) {
          // nanti kalau mau pindah halaman tinggal isi di sini
        },
      ),
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => UpdateStockPage(
                product: products[0], // Hanni dari list products
              ),
            ),
          );
        },
